...
export default function About() {
  ...
  return (
    <section id="about" ref={ref} className="min-h-screen flex flex-col justify-center items-center py-20 px-4 md:px-8">
      <motion.div
        style={{ opacity, y }}
      ...
      >
        <div className="perspective-1000">
          <motion.div
            className="relative w-full h-[400px] rounded-xl overflow-hidden transform-3d transition-transform duration-500 hover:rotate-y-10 hover:rotate-x-10 shadow-2xl"
            whileHover={{
              rotateY: 15,
              rotateX: 5,
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end p-6">
              <h3 className="text-2xl font-bold text-white">Antonio Morales</h3>
            </div>
          </motion.div>
        </div>
