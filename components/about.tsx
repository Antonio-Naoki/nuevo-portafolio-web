...
export default function About() {
  ...
  return (
    <section
      id="about"
      ref={ref}
      className="min-h-screen flex flex-col justify-center items-center py-12 xs:py-14 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8"
    >
      <motion.div
        style={{ opacity, y }}
      ...
      >
        <div className="perspective-1000 mx-auto md:mx-0 w-full max-w-[250px] xs:max-w-[280px] sm:max-w-sm md:max-w-none">
          <motion.div
            className="relative w-full h-[250px] xs:h-[280px] sm:h-[300px] md:h-[350px] lg:h-[400px] rounded-xl overflow-hidden transform-3d transition-transform duration-500 hover:rotate-y-10 hover:rotate-x-10 shadow-2xl"
            whileHover={{
              rotateY: 15,
              rotateX: 5,
          ...
          >
            <Image
              ...
              unoptimized
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end p-4 xs:p-5 sm:p-6">
              <h3 className="text-lg xs:text-xl sm:text-2xl font-bold text-white">Antonio Morales</h3>
            </div>
          </motion.div>
        </div>
        ...
        <div className="mt-6 md:mt-0">
          <motion.h2
            ...
            transition={{ duration: 0.5 }}
            viewport={{ once: true }}
            className="text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold mb-3 xs:mb-4 sm:mb-5 md:mb-6 bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent text-center md:text-left"
          >
            Sobre mí
          </motion.h2>
          ...
          <div className="space-y-2 xs:space-y-3 sm:space-y-4">
            {[
              ...
              <motion.p
                ...
                viewport={{ once: true }}
                className="text-gray-300 text-xs xs:text-sm sm:text-base"
              >
                {paragraph}
              </motion.p>
            ))}
